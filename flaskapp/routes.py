...
from flaskapp.forms import RegisterationForm, LoginForm, UpdateAccountForm, PostForm
...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash(f'Your account has now been created! You are able to log in' , 'success')
